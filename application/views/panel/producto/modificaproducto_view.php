		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="form-wrapper">
					...
					<?php echo form_input(['name' => 'categoria_id','id' => 'categoria_id','value'=>"$categoria_id" ,'class' => 'form-control','placeholder' => '1-Hombre - 2-Mujer - 3-Accesorios', 'autofocus' => 'autofocus']); ?>
				</div>
			</div>
		</div>
